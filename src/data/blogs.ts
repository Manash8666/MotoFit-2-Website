...
export const blogs: BlogPost[] = [
  {
    ...
    content: `
      ...
      <p><em>Want to hear how a Stage 2 Interceptor sounds? Check our 'Builds' highlight on Instagram.</em></p>
    `
  },
  {
    ...
    content: `
      ...
      <h2>Myth 3: 'Coolant is Coolant'</h2>
      <p>Using tap water or cheap green coolant in a high-compression superbike engine creates cavitation and corrosion. We only use high-boiling point coolants designed for aluminum engines.</p>
    `
  },
  {
    ...
    content: `
      ...
      <p>We don't just 'service' bikes for Ladakh; we fortify them.</p>
      ...
      <h2>Clutch Health</h2>
      <p>You will be slipping the clutch on inclines. If your plates are even 50% worn, replace them BEFORE you leave. We recommend reinforced clutch springs for fully loaded bikes.</p>
    `
  },
  {
