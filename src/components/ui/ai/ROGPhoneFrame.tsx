...
export function ROGPhoneFrame({ isOpen, onClose, messages, input, setInput, onSend, isLoading, mansiImage, isMuted, toggleMute }: ROGPhoneFrameProps) {
    ...
    return (
        ...
        <div
            className="fixed bottom-24 right-4 md:right-6 z-50 w-[90vw] md:w-[380px] h-[min(800px,80vh)] bg-[#0f0c29] rounded-[40px] border-[3px] border-[#00c8ff] shadow-[0_0_40px_rgba(0,200,255,0.4)] overflow-hidden flex flex-col animate-in slide-in-from-bottom-10 fade-in duration-300 origin-bottom-right"
            style={{
