            ...
            <div className="p-4 border-b border-white/10 flex items-center gap-3 bg-[#111]/90 backdrop-blur-sm relative z-10 shadow-sm">
                ...
                >
                    <div className="w-full h-full rounded-full border-2 border-black overflow-hidden">
                        <Image src={mansiImage || "/images/reels/mansi-day-2.png"} alt="Mansi" width={36} height={36} className="w-full h-full object-cover" />
                    </div>
                </button>
                    ...
                    >
                        ...
                        {msg.role === 'assistant' && (
                            <div className="w-7 h-7 rounded-full overflow-hidden mr-2 self-end mb-1">
                                <Image src={mansiImage || "/images/reels/mansi-day-2.png"} alt="Mansi Avatar" width={28} height={28} className="w-full h-full object-cover" />
                            </div>
                        )}
                ...
                {isLoading && (
                    <div className="flex justify-start items-center gap-2">
                        <div className="w-7 h-7 rounded-full overflow-hidden">
                            <Image src={mansiImage || "/images/reels/mansi-day-2.png"} alt="Mansi Typing" width={28} height={28} className="w-full h-full object-cover" />
                        </div>
                ...
                >
                    <div className="w-full aspect-square max-w-[300px] rounded-full p-[2px] bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] mb-4">
                        <div className="w-full h-full rounded-full border-4 border-black overflow-hidden">
                            <Image src={mansiImage || "/images/reels/mansi-day-2.png"} alt="Mansi Full" fill className="object-cover" />
                        </div>
                    </div>
