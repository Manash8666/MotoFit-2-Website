        ...
        <div className="flex flex-col h-full bg-black text-white font-sans relative overflow-hidden">
            ...
            <div className="p-4 border-b border-white/10 flex items-center gap-3 bg-[#111]/90 backdrop-blur-sm relative z-10 shadow-sm">
                ...
                >
                    <div className="w-full h-full rounded-full border-2 border-black overflow-hidden">
                        <Image src={mansiImage || "/images/reels/mansi-day-2.webp"} alt="Mansi" width={36} height={36} className="w-full h-full object-cover" />
                    </div>
                </button>
                    ...
                    <div key={i} className="flex flex-col items-center min-w-[60px] cursor-pointer">
                        <div className="w-14 h-14 rounded-full border border-white/20 p-[1px]">
                            <div className="w-full h-full rounded-full bg-[#111] flex items-center justify-center text-xl overflow-hidden relative">
                                <Image src={story.img} alt={story.title} fill className="object-cover opacity-60" />
                    ...
                    >
                        ...
                        {msg.role === 'assistant' && (
                            <div className="w-7 h-7 rounded-full overflow-hidden mr-2 self-end mb-1">
                                <Image src={mansiImage || "/images/reels/mansi-day-2.webp"} alt="Mansi Avatar" width={28} height={28} className="w-full h-full object-cover" />
                            </div>
                        )}
                ...
                {isLoading && (
                    <div className="flex justify-start items-center gap-2">
                        <div className="w-7 h-7 rounded-full overflow-hidden">
                            <Image src={mansiImage || "/images/reels/mansi-day-2.webp"} alt="Mansi Typing" width={28} height={28} className="w-full h-full object-cover" />
                        </div>
            ...
            <div className="p-3 bg-black flex items-center gap-3 relative z-10">
                <div className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center text-[#3797f0] cursor-pointer">
                    <Image src={mansiImage || "/images/reels/mansi-garage.png"} alt="Mansi Input Avatar" width={36} height={36} className="w-full h-full rounded-full object-cover" />
                </div>
                ...
                >
                    <div className="w-full aspect-square max-w-[300px] rounded-full p-[2px] bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] mb-4">
                        <div className="w-full h-full rounded-full border-4 border-black overflow-hidden">
                            <Image src={mansiImage || "/images/reels/mansi-day-2.webp"} alt="Mansi Full" fill className="object-cover" />
                        </div>
                    </div>
