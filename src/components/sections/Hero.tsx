      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 md:px-8">
        <div className="max-w-6xl mx-auto text-center space-y-8">
          ...
          <div className="overflow-hidden">
            <div className="inline-block backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl px-8 py-6 md:px-12 md:py-8">
              <h1 className="text-[clamp(3rem,10vw,8rem)] font-bold uppercase leading-[0.85] tracking-[0.1em] md:tracking-[0.25em]" style={{ fontFamily: 'var(--font-display), system-ui, sans-serif' }}>
                {titleWords.map((word, wordIndex) => {
                  const startIdx = titleWords.slice(0, wordIndex).join('').length;
                  return (
                    <span key={wordIndex} className="inline-block mr-8 md:mr-16 last:mr-0">
